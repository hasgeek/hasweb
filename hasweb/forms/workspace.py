...
from hasweb.models.workspace import funnel_status, workspace_types
...
class FunnelSpaceForm(Form):
    ...
    workspace_contains = wtf.SelectMultipleField(u"Workspace contains", coerce=int,
        choices=[(type, workspace_types[type]) for type in workspace_types], validators=[wtf.Required()])
